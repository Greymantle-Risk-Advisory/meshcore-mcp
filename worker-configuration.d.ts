/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f87e9a9bcac87f7aa82bcf36b9955fbf)
// Runtime types generated with workerd@1.20260701.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	MESH_NAME: "this MeshCore network";
	CORESCOPE_BASE_URL: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").MeshcoreMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MeshcoreMCP";
	}
